...
<body>
    <x-app-layout>
        <div class="sm:p-2 mb:p-6">

            <h1 class="sm:text-4xl mb:text-5xl font-bold mb-6 text-red-600">Админ панель</h1>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        ...
                                        <div>
                                            ...
                                            <form class="status-form" action="{{route('reports.status.update', $report->id)}}" method="POST">
                                                ...
                                                <select name="status_id" id="status_id" data-current-status="{{ $report->status_id }}" class="w-full min-w-[150px] sm:w-auto">
